...
- Section ids of a lesson share a prefix (`sets-`, `logic-`, `combi-`, `num-`, `pow-`, `alg-`, `prop-`, `lin-`) and that prefix must be added to the `.card[id^='…']` scroll-margin rule in `index.css`, or the sticky section nav covers the heading you jump to.
