...
/**
 * Arányosság, százalékszámítás, as six explorers: the constant quotient and
 * the constant product, the graph that tells a proportion from something that
 * merely grows with it, the three numbers of a percentage, why two percentage
 * changes never simply add up, and the interest that earns interest.
 */
